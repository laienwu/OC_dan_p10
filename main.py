...
class DashboardPart(Enum):
    PART_1 = "Data overview"
    PART_2 = "Regression linéaire"
    PART_3 = "Models explained"
    PART_4 = "Test model"
...
if __name__ == '__main__':
    ...
    side_bar = st.sidebar.selectbox("Select your topic: ", [i.value for i in DashboardPart], index=0)
    ...
    match side_bar:
        # region part 1
        case DashboardPart.PART_1.value:
        ...
        case DashboardPart.PART_2.value:
            # region part 2
            list_select = ("True", "False", 'Both')
            select = st.sidebar.selectbox('Selection la nature des billets', list_select, index=2)
            dict_select = {"True": False, "False": True, "Both": pd.NA}
        ...
        # region part 3
        case DashboardPart.PART_3.value:
            st.markdown(
        ...
        # region part 4
        case DashboardPart.PART_4.value:
